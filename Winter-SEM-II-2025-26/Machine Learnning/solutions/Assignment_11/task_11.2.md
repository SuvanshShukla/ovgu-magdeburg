...
$C''_1 = (0.4, 0.4) + 0.2 * ((0.4,1.6) + (2.4,1.6) - (0.4,0.6))$$
$C''_1 = (0.4, 0.4) + 0.2 * (0.4 + 2.4 - 0.4, 1.6 + 1.6 - 0.6)$
$C''_1 = (0.4, 0.4) + 0.2 * (2.4, 2.6)$
$C''_1 = (0.4, 0.4) + (0.48, 0.52)$
$C''_1 = (0.88, 0.92)$

$C''_2 = (5, 5.2) + 0.2 * ((0, 3.8) + (0, -4.2))$
$C''_2 = (5, 5.2) + 0.2 * (0, -0.4)$
$C''_2 = (5, 5.2) + (0, -0.08)$
$C''_2 = (5, 5.12)$

### Part B ($\eta = 0.5$) & 4 iterations
