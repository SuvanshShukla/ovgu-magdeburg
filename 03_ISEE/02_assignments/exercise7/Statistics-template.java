public class Statistics {
  public static void main(String[] args) {
    ...
    // if (args.length > 0) {
    //   x = Double.parseDouble(args[9]); // get input from command line
    // }
    ...
    for (int i = 0; i < args.length; i++) {
      v += Math.pow(Double.parseDouble(args[i]) - o, 2);
    }
    ...
    for (int i = 0; i < args.length; i++) {
      int Zahl = (int) Double.parseDouble(args[i]);
      q[Zahl]++; // q counts how often a number occurs
    }
